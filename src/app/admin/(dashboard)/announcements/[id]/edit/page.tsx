  ...
  return (
    <div className="max-w-3xl space-y-6">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-2xl font-serif font-bold text-white">Edit Announcement</h1>
        <p className="text-navy-400 text-sm">Update church announcement</p>
      </motion.div>
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <label className="flex items-center gap-3 cursor-pointer">
            ...
            />
            <span className="text-sm text-navy-300">Pinned</span>
          </label>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            <input
              ...
              className="w-4 h-4 rounded bg-navy-900 border-navy-700 text-gold-500 focus:ring-gold-500/50"
            />
            <span className="text-sm text-navy-300">Published</span>
          </label>
        </div>
